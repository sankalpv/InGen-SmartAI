/**
 * Ollama AI Client (Mac-only)
 * Handles both LLM generation and embeddings via local Ollama.
 * 
 * Bedrock is used separately by specific services (ai-stream, chat-engine, etc.)
 * for enhanced AI summaries — not routed through this client.
 */
...
class OllamaClient {
  ...
  /**
   * Generate text completion using local Ollama LLM
   */
