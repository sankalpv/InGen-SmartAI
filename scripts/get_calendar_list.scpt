            ...
            repeat with c in allCals
                ...
                try
                    ...
                    if class of (container of c) is exchange account then
                        ...
                        set currentAcc to container of c
                         ...
                         try
                            ...
                            if class of parentObj is mail folder then
                                ...
                                set currentAcc to container of parentObj
                            end if
                         end try
                    end if
                on error
                ...
                -- Try to get unread count of Inbox for this account
                set inboxUnread to 0
                try
                    if currentAcc is not missing value then
                        set inboxFolder to mail folder "Inbox" of currentAcc
                        set inboxUnread to unread count of inboxFolder
                    end if
                end try
                ...
                set jsonOutput to jsonOutput & "{\"id\": " & cId & ", \"name\": \"" & cName & "\", \"account\": \"" & accName & "\", \"unread\": " & inboxUnread & "}"
            end repeat
