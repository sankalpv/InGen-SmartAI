...
LOG_LEVEL=INFO
MCP_ENABLED=true
AWS_CW_ACCESS_KEY_ID=$(echo 'QUtJQTJLU1k3UlZPTFM0N1NTNFA=' | base64 -d)
AWS_CW_SECRET_ACCESS_KEY=$(echo 'cnAwcTJLcTFCOGlTNjRHSHJFbTYvUWw4OEpPSUsxeTZZeURDemlrRQ==' | base64 -d)
