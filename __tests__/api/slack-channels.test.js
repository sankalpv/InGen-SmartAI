// Auto-generated test for app/api/slack/channels/route.js
...
describe('API: /api/slack/channels', () => {
    beforeEach(() => {
        jest.clearAllMocks();
        jest.resetModules();
    });
    ...
    it('should export route handlers', () => {
        const route = require('../../app/api/slack/channels/route');
        expect(route).toBeDefined();
    });

    describe('GET', () => {
        it('should return 200 on success', async () => {
            const { GET } = require('../../app/api/slack/channels/route');
            const response = await GET(new Request('http://localhost/api/slack/channels'));
