// Auto-generated test for app/api/insights/route.js
...
describe('API: /api/insights', () => {
    ...
    it('should export route handlers', () => {
        const route = require('../../app/api/insights/route');
        expect(route).toBeDefined();
    });

    describe('GET', () => {
        it('should return 200 on success', async () => {
            const { GET } = require('../../app/api/insights/route');
    ...
    describe('POST', () => {
        it('should return response on valid input', async () => {
            const { POST } = require('../../app/api/insights/route');
